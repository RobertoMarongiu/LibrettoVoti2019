...
public class TestLibretto {
	...
	public static void main(String[] args) {
		...
		libr.add(new Voto(30, "Analisi I", LocalDate.of(2017, 1, 5)));
		...
		libr.add(new Voto(25, "Logistica", LocalDate.of(2017, 1, 15)));
		libr.add(new Voto(27, "Programmazione Oggetti", LocalDate.of(2017, 1, 15)));
